...
def cVsAsm():
	fileOcero = '0.salida.caso.YUV2RGB C O0.txt' 
	fileOtres = '0.salida.caso.YUV2RGB C O3.txt'
	fileASM =   '1.salida.caso.YUV2RGB Original.txt'
	...
	ax.set_title('Performance de YUVtoRGB entre C-O0, C-O3 y ASM')
	#plt.suptitle('de Rotar ASM y Rotar C', y=1.05, fontsize=17)
	ax.set_xticks(ind + 0.4)
	ax.set_xticklabels(('C-O0','C-O3','ASM'))
	plt.ticklabel_format(style='sci', axis='y', scilimits=(0,0))
...
def write2vs4Absoluto():
	filewrite2 = '0.salida.caso.YUV2RGB C O3.txt' 
	filewrite4 = '1.salida.caso.YUV2RGB Original.txt'
	...
	ax.set_ylabel('Ciclos de clock')
	ax.set_title('Performance de YUVtoRGB entre C-O3 y ASM')
