...
ASM_convertYUVtoRGB:
	...
	movdqu xmm8, [mask128]
	movdqu xmm9, [mask255]
	movdqu xmm10, [mask100]
	movdqu xmm11, [mask208]
	movdqu xmm12, [mask516]
...
ASM_convertRGBtoYUV:
	...
	.cicloAlto:
		...
		.cicloAncho:
			...
			; calculos Y
			movdqu xmm5, xmm1
			pmulld xmm5, xmm12 ; | 66*r3 | 66*r2 | 66*r1 | 66*r0 |
			...
			movdqu xmm14, xmm3
			pmulld xmm14, xmm11 ; | 112*b3 | 112*b2 | 112*b1 | 112*b0 |
			...
			; calculos V
			movdqu xmm7, xmm1
			pmulld xmm7, xmm11 ; | 112*r3 | 112*r2 | 112*r1 | 112*r0 |
